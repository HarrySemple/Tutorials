...
},
{
  ...
  "type": "Claim",
  "number": "14",
  "title": "Second Partial Derivatives Test (Theorem 2.8).",
  "body": " Second Partial Derivatives Test (Theorem 2.8)   Let be a function of two variables with continuous second-order partial derivatives in some disc centred at a critical point , and let    If and then is a local minimum.    If and then is a local maximum.    If then is a saddle point.      "
},
{
...
},
{
  ...
  "type": "Theorem",
  "number": "15",
  "title": "Second Derivatives Test in 1D.",
  "body": " Second Derivatives Test in 1D   Let be a function with continuous second-order derivatives in some interval centred at a critical point .   If then is a local minimum.    If then is a local maximum.    If then the test is inconclusive.      "
},
{
...
},
{
  ...
  "body": " The Normal Distribution III   Specifying Variables  Combining and , we have Thus, our PDF can be simplifiied as   Our new aim is to write the variance in terms of the PDF, defined as where is the mean, which is in our darts paradigm. Thus This gives the relation Thus, Lastly, we take into account cases where we have a non-zero mean. This refers to a translation along the axis, giving us a final PDF of  See it for yourself!      "
},
{
